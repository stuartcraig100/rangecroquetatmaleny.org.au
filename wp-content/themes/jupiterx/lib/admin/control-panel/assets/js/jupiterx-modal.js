...
(function ($, window, document) {
    ...
    $.extend(Modal.prototype, {
        ...
        templateBuilder: function templateBuilder() {
            ...
            html += '<div id="jupiterx-modal" class="jupiterx-modal ' + typeClass + modalCustomClass + '">';
            ...
            if (options.showConfirmButton || options.showCancelButton) {
                ...
                if (options.showConfirmButton) {
                    html += '<button type="button" class="btn btn-primary js__modal-btn-confirm" >' + options.confirmButtonText + '</button>';
                }
                if (options.showCancelButton) {
                    html += '<button type="button" class="btn btn-secondary js__modal-btn-cancel">' + options.cancelButtonText + '</button>';
                }
