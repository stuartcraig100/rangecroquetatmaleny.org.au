...
class JupiterX_Control_Panel_Export_Import {
	...
	private function export_settings() {
		try {
			...
			$option_keys = apply_filters( 'jupiterx_extra_export_option_keys', array() );
			...
			// Export list of supported active plugins.
			...
			unset( $data['mods']['sidebars_widgets'] );
	...
	private function export_end() {
		try {
			...
			$this->jupiterx_filesystem->zip_custom(
				[
					$this->_prepare_directory_name() . '/theme_content.xml' => $this->folder['export_dir'] . '/theme_content.xml',
					$this->_prepare_directory_name() . '/widget_data.wie'   => $this->folder['export_dir'] . '/widget_data.wie',
					$this->_prepare_directory_name() . '/settings.json'     => $this->folder['export_dir'] . '/settings.json',
				],
				$this->folder['export_dir'] . '/' . $this->_prepare_directory_name() . '.zip',
				true
			);
