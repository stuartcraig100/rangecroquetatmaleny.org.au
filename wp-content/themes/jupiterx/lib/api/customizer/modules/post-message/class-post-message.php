...
final class JupiterX_Customizer_Post_Message {
	...
	public function enqueue_preview_scripts() {
		wp_enqueue_script( 'jupiterx-customizer-postmessage', JUPITERX_CUSTOMIZER_URL . 'assets/js/post-message' . JUPITERX_MIN_JS . '.js', [ 'jquery', 'kirki_auto_postmessage' ], JUPITERX_VERSION, true );
