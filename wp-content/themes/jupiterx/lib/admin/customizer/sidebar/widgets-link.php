...
JupiterX_Customizer::add_field( [
	...
	'output'    => [
		[
			'element'  => '.jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a, .jupiterx-sidebar .jupiterx-widget .jupiterx-recent-comment .comment-author-link:before',
			'property' => 'color',
		],
	],
] );
...
JupiterX_Customizer::add_field( [
	...
	'output'      => [
		[
			'element'  => '.jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a, .jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a span',
...
JupiterX_Customizer::add_field( [
	...
	'output'    => [
		[
			'element'  => '.jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a:hover, .jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a:hover span, .jupiterx-sidebar .jupiterx-widget .jupiterx-recent-comment:hover .comment-author-link:before',
			'property' => 'color',
		],
	],
] );
...
JupiterX_Customizer::add_field( [
	...
	'output'      => [
		[
			'element'  => '.jupiterx-sidebar .jupiterx-widget:not(.widget_jupiterx_social) a:hover',
			'property' => 'text-decoration',
		],
	],
] );
