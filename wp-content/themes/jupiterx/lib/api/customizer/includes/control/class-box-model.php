		...
		<div class="jupiterx-control jupiterx-box-model-control">
			<# _.each( properties, function ( props, key ) { #>
				<# if ( data.exclude.indexOf( key ) < 0 ) { #>
					<div class="jupiterx-box-model-control-property">
						...
						<# _.each( sides, function ( side ) {
							...
							<input class="jupiterx-box-model-control-input jupiterx-box-model-control-{{ side }}" min="{{ props.min }}" {{{ data.inputAttrs }}} type="text" value="{{ value }}" placeholder="-" {{{ data.link }}} data-setting-property-link="{{ propertyName }}" />
						<# } ) #>
				<# } #>
			<# } ) #>
				...
				<# _.each( properties, function ( props, key ) { #>
					<# if ( data.exclude.indexOf( key ) < 0 ) { #>
						...
						<div class="jupiterx-control-units-container">
							...
							<ul class="jupiterx-control-unit-selector">
