...
class JupiterX_Widget extends WP_Widget {
	...
	public function scripts() {
		...
		wp_enqueue_script( 'jupiterx-widget-controls', JUPITERX_ADMIN_URL . 'assets/js/widget-controls.js', array( 'jquery' ), JUPITERX_VERSION, false );
		wp_enqueue_script( 'jupiterx-jquery-conditioner', JUPITERX_ADMIN_URL . 'assets/lib/jquery.conditioner.js', array( 'jquery' ), JUPITERX_VERSION, false );

		if ( ! wp_script_is( 'jquery-elementor-select2', 'enqueued' ) ) {
			wp_enqueue_script( 'jupiterx-select2', JUPITERX_ADMIN_URL . 'assets/lib/select2/select2.full.js', array( 'jquery' ), JUPITERX_VERSION, false );
		}
	}
	...
	public function styles() {
		...
		wp_enqueue_style( 'wp-color-picker' ); // @phpcs:ignore
		wp_enqueue_style( 'jupiterx-widget-controls', JUPITERX_ADMIN_URL . 'assets/css/widget-controls.css', [], JUPITERX_VERSION );
